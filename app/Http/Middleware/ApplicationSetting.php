...
class ApplicationSetting
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (! session()->get('locale')) {
            session()->put('locale', Settings::get('app_name'));
        }
         ...
         *  User Setting
         */
        config(['access.users.registration' => Settings::get('access_users_registration') === 'true' ? true : false]);
        config(['access.users.confirm_email' => Settings::get('access_users_confirm_email') === 'true' ? true : false]);
        config(['access.users.change_email' => Settings::get('access_users_change_email') === 'true' ? true : false]);
        config(['access.captcha.registration' => Settings::get('access_captcha_registration') === 'true' ? true : false]);
