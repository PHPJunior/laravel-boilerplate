...
trait Dropdowns
{
     ...
     * @return mixed
     */
    public function selectMailDriver($name, $selected = null, $options = [])
    {
        $list = [
             null       => 'Please Select',
            'mail'      => 'mail',
     ...
     * @return mixed
     */
    public function selectMailEncryption($name, $selected = null, $options = [])
    {
        $list = [
            'ssl'  => 'SSL',
            'tls'  => 'TLS'
    ...
    public function selectBackendTheme($name, $selected = null, $options = [])
    {
        $list = [
            'black' => 'Black',
    ...
    public function selectBackendLayout($name, $selected = null, $options = [])
    {
        $list = [
            'fixed'  => 'Fixed',
     ...
     * @return mixed
     */
    public function selectLanguage($name, $selected = null, $options = [])
    {
        $list = [];
     ...
     * @return mixed
     */
    public function selectLanguageLineGroup($name, $selected = null, $options = [])
    {
        $list = [];
     ...
     * @return mixed
     */
    public function selectBroadcastingDefault($name, $selected = null, $options = [])
    {
        $list = [
            'null'     => 'Null',
            'pusher'   => 'Pusher',
     ...
     * @return mixed
     */
    public function selectCacheDefault($name, $selected = null, $options = [])
    {
        $list = [
            'apc'       => 'Apc',
            'array'     => 'Array',
